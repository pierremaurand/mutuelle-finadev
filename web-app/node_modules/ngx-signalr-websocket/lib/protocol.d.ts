...
export declare type IHubMessage = IInvocationMessage | IStreamInvocationMessage | IStreamItemMessage | ICompletionMessage | ICancelInvocationMessage | IPingMessage | ICloseMessage;
...
export declare const handshakeRequest: IHandshakeRequest;
export declare const pingMessage: IPingMessage;
export declare const closeMessage: ICloseMessage;
export declare const createInvocationMessage: (target: string, args: unknown[], invocationId?: string, headers?: IMessageHeaders) => IInvocationMessage;
export declare const createStreamInvocationMessage: (target: string, args: unknown[], invocationId: string, headers?: IMessageHeaders) => IStreamInvocationMessage;
export declare const createCancelInvocationMessage: (invocationId: string, headers?: IMessageHeaders) => ICancelInvocationMessage;
